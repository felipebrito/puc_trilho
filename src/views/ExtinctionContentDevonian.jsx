...
import './ExtinctionContentDevonian.css';

const ExtinctionContentDevonian = ({ onNavigate, slideData }) => {
    useEffect(() => {
    ...
    return (
        <div className="view-extinction-content-devonian animate-fade-in" style={{ width: '1080px', height: '1920px', position: 'relative', overflow: 'hidden', backgroundColor: '#ffffff' }}>
                ...
                <div style={{ position: 'absolute', top: 0, left: 0, transformOrigin: '0px 0px', height: '123.81px', width: '1080px', transform: 'scale(1)' }}>
                    <div style={{ width: '1080px', height: '123.81px', marginLeft: 0, marginTop: 0 }}>
                        <svg style={{ position: 'absolute', width: 0, height: 0 }}>
                            <defs>
                                <clipPath id="__id-dev-ext">
                                    <path d="M0,0L2233.092515174864,0L2233.092515174864,256L0,256Z" />
                                </clipPath>
                            </defs>
                        </svg>
                        <div style={{ clipPath: 'url(#__id-dev-ext)', background: 'rgb(0, 95, 255)', width: '2233.09px', height: '256px', transform: 'scale(0.483634, 0.483634)', transformOrigin: '0 0' }}></div>
                    </div>
                </div>
            </div>

            {/* EXTINÇÃO TITLE IMAGE */}
            <div id="dev-ext-title-img" style={{ position: 'absolute', width: '354.456px', height: '47.8681px', transform: 'translate(362.772px, 39.4381px)' }}>
            ...
            {/* PUC Logo */}
            <div id="dev-ext-puc-logo" style={{ position: 'absolute', width: '350.84px', height: '89.6831px', transform: 'translate(621.16px, 1723.87px)' }}>
            ...
            {/* Museu Logo */}
            <div id="dev-ext-museu-logo" style={{ position: 'absolute', width: '344.755px', height: '88.1275px', transform: 'translate(108px, 1723.87px)' }}>
            ...
            {/* MAP IMAGE */}
            <div id="dev-ext-map" style={{ position: 'absolute', width: '975.743px', height: '487.871px', transform: 'translate(52.1286px, 628.147px)' }}>
                <motion.img variants={blurVariants} initial="hidden" animate="visible" src={slideData.imageSrc} alt="Mapa Devoniano" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
            </div>

            {/* TEXT #1 (Top Text) */}
            <div id="dev-ext-top-text" style={{ position: 'absolute', width: '864px', height: '420.387px', transform: 'translate(108px, 180.706px)' }}>
            ...
            {/* TEXT #2 (Map Caption) */}
            <div id="dev-ext-caption" style={{ position: 'absolute', width: '919.871px', height: '105.335px', transform: 'translate(108px, 1143.02px)' }}>
            ...
            {/* STROKE LINE */}
            <div id="dev-ext-line" style={{ position: 'absolute', width: '890.54px', height: '4px', transform: 'translate(108px, 1246.35px)' }}>
            ...
            {/* TEXT #3 (Bottom Text) */}
            <div id="dev-ext-bottom-text" style={{ position: 'absolute', width: '898.552px', height: '326.387px', transform: 'translate(108px, 1307.35px)' }}>
...
export default ExtinctionContentDevonian;
